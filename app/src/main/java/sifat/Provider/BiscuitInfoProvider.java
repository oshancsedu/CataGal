...
public class BiscuitInfoProvider implements ProductInfoProvider {
    ...
    public static void setProductInfos() {
        ...
        memoProductInfo = new MemoProductInfo("Bengal Master Slice", "Family Pack", "6 pack/carton", "Carton", 210, 1);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Master Slice", "Regular Pack", "24 pack/carton", "Carton", 240, 1);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Master Slice", "Mini Pack", "40 pack/carton", "Carton", 200, 1);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Pine-Apple Cream", "Family Pack", "8 pack/carton", "Carton", 200, 2);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Pine-Apple Cream", "Regular Pack", "20 pack/carton", "Carton", 200, 2);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Pine-Apple Cream", "Mini Pack", "40 pack/carton", "Carton", 200, 2);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Nutribake Digestives Biscuit", "Family Pack", "8 box/carton", "Carton", 480, 3);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Nutribake Digestives Biscuit", "Mini Pack", "40 pack/carton", "Carton", 192, 3);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Orange Cake Biscuit", "Family Pack", "5 pack/carton", "Carton", 200, 4);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Orange Cake Biscuit", "Regular Pack", "24 pack/carton", "Carton", 288, 4);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Orange Cake Biscuit", "Tin", "1 tin", "Tin", 200, 4);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Hit Cream Biscuit", "Family Pack", "5 pack/carton", "Carton", 175, 5);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal B-vita Biscuit", "Family Pack", "5 pack/carton", "Carton", 150, 6);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bengal Lemon Biscuit", "Family Pack", "8 pack/carton", "Carton", 176, 7);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Bingo Toast Biscuit", "Family Pack", "6 pack/carton", "Carton", 300, 8);
        memoProductInfos.add(memoProductInfo);
        ...
        memoProductInfo = new MemoProductInfo("Kingdom Kheer Cookies", "Family Pack", "5 pack/carton", "Carton", 250, 9);
        memoProductInfos.add(memoProductInfo);
